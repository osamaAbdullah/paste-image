...
Nova.booting(function (Vue, router) {
    Vue.component('index-paste-image', __webpack_require__(3));
    Vue.component('detail-paste-image', __webpack_require__(6));
    Vue.component('form-paste-image', __webpack_require__(9));
});
  ...
  return _c("p", [
    _vm.field.thumbnailUrl
      ? _c("img", {
          ...
          attrs: { src: "/images/" + _vm.field.value + "/get-preview-image" }
        })
      : _c("span", [_vm._v("—")])
  ])
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__IconButton__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UploadIcon__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(24);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fetchImage: function fetchImage() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Minimum"])(axios.get('/images/' + this.field.value + '/get-preview-image', {
                responseType: 'blob'
            })).then(function (_ref) {
