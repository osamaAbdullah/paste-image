...
Nova.booting(function (Vue, router) {
    Vue.component('index-image-upload-preview', __webpack_require__(3));
    Vue.component('detail-image-upload-preview', __webpack_require__(6));
    Vue.component('form-image-upload-preview', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fetchImage: function fetchImage() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Minimum"])(axios.get('/orders/order/' + this.field.value + '/get-preview-image', {
                responseType: 'blob'
            })).then(function (_ref) {
